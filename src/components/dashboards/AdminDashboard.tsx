...
const AdminDashboard: React.FC = () => {
  ...
  const handleTabChange = useCallback((tabValue: string, scrollBehavior: 'auto' | 'force' | 'none' = 'auto') => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div ref={tabsContentRef}>
        ...
        >
          <TabsList className='grid w-full grid-cols-4 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1'>
