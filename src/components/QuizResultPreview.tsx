...
const QuizResultPreview: React.FC<Props> = ({ quizQuestions, answers, score, onClose,onRetry }) => {
    const [showConfirm ,setShowConfirm] = useState(false);
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-semibold">Your Score: {score}/{quizQuestions.length}</h3>
        ...
        !showConfirm ? (
            <>
             <Button variant="destructive" onClick={()=>setShowConfirm(true)}
                className="w-full">Retry Quiz</Button>
