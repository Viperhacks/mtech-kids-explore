...
const Exercises = () => {
  ...
  const [activeTab, setActiveTab] = React.useState<string>("exercises");
        ...
        <TabsContent value="documents" className="min-h-[200px]">
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-mtech-primary/5 p-6 rounded-lg mb-6">
                <h3 className="text-lg font-medium text-mtech-primary mb-3">Grade 5 Worksheets</h3>
                <DocumentResourcesViewer grade="5" limit={6} />
              </div>
              
              <div className="bg-blue-50 p-6 rounded-lg mb-6">
                <h3 className="text-lg font-medium text-blue-700 mb-3">Grade 4 Worksheets</h3>
                <DocumentResourcesViewer grade="4" limit={6} />
              </div>
              
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-lg font-medium text-green-700 mb-3">Grade 3 Worksheets</h3>
                <DocumentResourcesViewer grade="3" limit={6} />
              </div>
            </div>
          </div>
        </TabsContent>
